...
const links = [
  ...
  { to: "/admin/vendors", icon: ShieldCheck, label: "Vendors" },
...
const SidebarHeader = ({ collapsed, onToggle }) => (
  ...
  >
    {!collapsed && (
      <div>
        <p className="text-base font-bold text-gray-950">Admin Panel</p>
        <p className="mt-0.5 text-xs text-gray-500">Control your marketplace</p>
      </div>
    )}
